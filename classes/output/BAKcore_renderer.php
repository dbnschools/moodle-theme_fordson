...
class core_renderer extends \core_renderer {
    ...
    public function social_icons() {
        ...
        $hasnav1buttonurl   = (empty($PAGE->theme->settings->nav1buttonurl)) ? false : $PAGE->theme->settings->nav1buttonurl;
        $hasnav2buttonurl   = (empty($PAGE->theme->settings->nav2buttonurl)) ? false : $PAGE->theme->settings->nav2buttonurl;
        $hasnav3buttonurl   = (empty($PAGE->theme->settings->nav3buttonurl)) ? false : $PAGE->theme->settings->nav3buttonurl;
        $hasnav4buttonurl   = (empty($PAGE->theme->settings->nav4buttonurl)) ? false : $PAGE->theme->settings->nav4buttonurl;
        $hasnav5buttonurl   = (empty($PAGE->theme->settings->nav5buttonurl)) ? false : $PAGE->theme->settings->nav5buttonurl;
        $hasnav6buttonurl   = (empty($PAGE->theme->settings->nav6buttonurl)) ? false : $PAGE->theme->settings->nav6buttonurl;
        $hasnav7buttonurl   = (empty($PAGE->theme->settings->nav7buttonurl)) ? false : $PAGE->theme->settings->nav7buttonurl;
        $hasnav8buttonurl   = (empty($PAGE->theme->settings->nav8buttonurl)) ? false : $PAGE->theme->settings->nav8buttonurl;
        $hasnav1buttontext   = (empty($PAGE->theme->settings->nav1buttontext)) ? false : $PAGE->theme->settings->nav1buttontext;
        $hasnav2buttontext   = (empty($PAGE->theme->settings->nav2buttontext)) ? false : $PAGE->theme->settings->nav2buttontext;
        $hasnav3buttontext   = (empty($PAGE->theme->settings->nav3buttontext)) ? false : $PAGE->theme->settings->nav3buttontext;
        $hasnav4buttontext   = (empty($PAGE->theme->settings->nav4buttontext)) ? false : $PAGE->theme->settings->nav4buttontext;
        $hasnav5buttontext   = (empty($PAGE->theme->settings->nav5buttontext)) ? false : $PAGE->theme->settings->nav5buttontext;
        $hasnav6buttontext   = (empty($PAGE->theme->settings->nav6buttontext)) ? false : $PAGE->theme->settings->nav6buttontext;
        $hasnav7buttontext   = (empty($PAGE->theme->settings->nav7buttontext)) ? false : $PAGE->theme->settings->nav7buttontext;
        $hasnav8buttontext   = (empty($PAGE->theme->settings->nav8buttontext)) ? false : $PAGE->theme->settings->nav8buttontext;

        $fp_iconnavcontext = [

            // If any of the above social networks are true, sets this to true.
            'hasfpiconnav' => ($hasnav1icon || $hasnav2icon || $hasnav3icon || $hasnav4icon || $hasnav5icon
                || $hasnav6icon || $hasnav7icon || $hasnav8icon || $hasnav1buttonurl || $hasnav2buttonurl || $hasnav3buttonurl || $hasnav4buttonurl
                 || $hasnav5buttonurl || $hasnav6buttonurl || $hasnav7buttonurl || $hasnav8buttonurl || $hasnav1buttontext || $hasnav2buttontext || $hasnav3buttontext
                  || $hasnav4buttontext || $hasnav5buttontext || $hasnav6buttontext || $hasnav7buttontext || $hasnav8buttontext) ? true : false,

            'fpiconnav' => array(
                array('hasicon' => $hasnav1icon, 'linkicon' => $hasnav1icon),
                array('hasicon' => $hasnav2icon, 'linkicon' => $hasnav2icon),
                array('hasicon' => $hasnav3icon, 'linkicon' => $hasnav3icon),
                array('hasicon' => $hasnav4icon, 'linkicon' => $hasnav4icon),
                array('hasicon' => $hasnav5icon, 'linkicon' => $hasnav5icon),
                array('hasicon' => $hasnav6icon, 'linkicon' => $hasnav6icon),
                array('hasicon' => $hasnav7icon, 'linkicon' => $hasnav7icon),
                array('hasicon' => $hasnav8icon, 'linkicon' => $hasnav8icon),
                array('haslink' => $hasnav1buttonurl, 'link' => $hasnav1buttonurl),
                array('haslink' => $hasnav2buttonurl, 'link' => $hasnav2buttonurl),
                array('haslink' => $hasnav3buttonurl, 'link' => $hasnav3buttonurl),
                array('haslink' => $hasnav4buttonurl, 'link' => $hasnav4buttonurl),
                array('haslink' => $hasnav5buttonurl, 'link' => $hasnav5buttonurl),
                array('haslink' => $hasnav6buttonurl, 'link' => $hasnav6buttonurl),
                array('haslink' => $hasnav7buttonurl, 'link' => $hasnav7buttonurl),
                array('haslink' => $hasnav8buttonurl, 'link' => $hasnav8buttonurl),
                array('hastext' => $hasnav1buttontext, 'linktext' => $hasnav1buttontext),
                array('hastext' => $hasnav2buttontext, 'linktext' => $hasnav2buttontext),
                array('hastext' => $hasnav3buttontext, 'linktext' => $hasnav3buttontext),
                array('hastext' => $hasnav4buttontext, 'linktext' => $hasnav4buttontext),
                array('hastext' => $hasnav5buttontext, 'linktext' => $hasnav5buttontext),
                array('hastext' => $hasnav6buttontext, 'linktext' => $hasnav6buttontext),
                array('hastext' => $hasnav7buttontext, 'linktext' => $hasnav7buttontext),
                array('hastext' => $hasnav8buttontext, 'linktext' => $hasnav8buttontext),
            )
        ];

        return $this->render_from_template('theme_fordson/fp_iconnav', $fp_iconnavcontext);
